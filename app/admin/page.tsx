  ...
  return (
    <div style={{minHeight: '100vh', backgroundColor: '#14141f'}}>
      ...
      <div style={{maxWidth: '800px', margin: '0 auto', padding: '40px 24px'}}>
        <h1 style={{fontFamily: 'Georgia, serif', fontSize: '28px', fontWeight: '600', color: '#f1f5f9', marginBottom: '4px'}}>Moderation queue</h1>
          ...
          <div style={{marginBottom: '40px'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '12px'}}>
              {criticReviews.map((review) => (
                <div key={review.id} style={{backgroundColor: '#1e1e2e', border: '1px solid #2a2a3e', borderRadius: '4px', padding: '20px'}}>
                  <div style={{display: 'flex', justifyContent: 'space-between', marginBottom: '8px', flexWrap: 'wrap', gap: '8px'}}>
                    <div>
                      <span style={{fontSize: '14px', fontWeight: '600', color: '#f1f5f9'}}>{review.productions?.shows?.title}</span>
                  ...
                  {review.pull_quote && <p style={{fontSize: '13px', color: '#9ca3af', fontStyle: 'italic', margin: '0 0 12px 0'}}>"{review.pull_quote}"</p>}
