...
function getTicketUrl(company: string, city: string, title: string, country: string): string {
  ...
  const companyDirect: Record<string, string> = {
    ...
    'Metropolitan Musical Theatre Company of SA': 'https://mmtcsa.com.au/',
    'Therry Dramatic Society': 'https://www.therry.com.au/',
    'Hills Musical Company': 'https://hillsmusical.com.au/',
    'Adelaide University Theatre Guild': 'https://adelaideunitheatreguild.org/',
    ...
    'GRADS Theatre Company': 'https://www.gradstheatre.com/',
    'Bel Canto Performing Arts': 'https://www.belcantopa.com.au/',
    ...
    'Canberra Philharmonic Society': 'https://www.philharmonic.org.au/',
    'Free Rain Theatre Co': 'https://www.freeraintheatre.com.au/',
  }
