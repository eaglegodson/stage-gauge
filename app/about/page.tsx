    ...
    <main style={{ minHeight: '100vh', backgroundColor: '#14141f' }}>
      ...
      <div style={{ maxWidth: '720px', margin: '0 auto', padding: '64px 24px' }}>
        ...
        <section style={{ marginBottom: '56px' }}>
          ...
          <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: '1.8', margin: '0 0 16px 0' }}>
            The StageGauge score is a straight average of explicit star ratings — from critics and audience members combined. We only count ratings that are explicitly stated. We don't infer scores from sentiment or language.
          </p>
          <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: '1.8', margin: 0 }}>
        ...
        <section style={{ marginBottom: '56px' }}>
          <h2 style={{ fontFamily: 'Georgia, serif', fontSize: '24px', fontWeight: '600', color: '#f1f5f9', margin: '0 0 16px 0' }}>We're in beta</h2>
          <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: '1.8', margin: '0 0 16px 0' }}>
            StageGauge is new. The pipeline runs every night and the database grows daily — but there will be gaps, missing shows, and the occasional matching error. We're working on it.
          </p>
          <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: '1.8', margin: 0 }}>
            If you spot a show that's missing, a review that's wrong, or anything that doesn't look right — please let us know. Every piece of feedback makes the product better.
          </p>
        </section>
        ...
        <section style={{ marginBottom: '56px' }}>
          ...
          <p style={{ fontSize: '15px', color: '#9ca3af', lineHeight: '1.8', margin: '0 0 24px 0' }}>
            StageGauge is built and maintained by a small team in Melbourne. We'd love to hear from you — whether it's feedback, a bug report, or just to say hello.
          </p>
          
            href="mailto:hello@stagegauge.com"
            style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', fontSize: '14px', fontWeight: '600', color: 'white', padding: '12px 24px', borderRadius: '8px', backgroundColor: '#1D9E75', textDecoration: 'none' }}
          >
            ✉️ hello@stagegauge.com
          </a>
        </section>
      ...
      <div style={{ borderTop: '1px solid #1e1e2e', padding: '24px', textAlign: 'center' }}>
        <p style={{ fontSize: '13px', color: '#4b5563', margin: 0 }}>© 2026 StageGauge · <a href="mailto:hello@stagegauge.com" style={{ color: '#4b5563', textDecoration: 'none' }}>hello@stagegauge.com</a></p>
      </div>
    </main>
  )
}
